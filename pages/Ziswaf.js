...
class Ziswaf extends Component {
  ...
  listZiswaf(){
    axios({
      method: 'get',
      url: URL+'/admin_sosial/SelectPageZiswaf',
      responseType: 'stream'
    }).then((result) => {
        if(result.data.pendanaan == ""){
         ...
         this.setState({
            ...
            shows_list_ziswaf : result.data.pendanaan
...
getURLZakat(){
  ...
  render(){
    ...
    return(
      <LayoutHome title="Ziswaf" status_user={this.state.session_username} id_status_user={this.state.session_id_status_user}>
            ...
            <div id="shop" className="section nomargin page-section nobg clearfix">
              <div className="container clearfix">
                ...
                <div className="row clearfix">
                  ...
                  {
                  this.state.shows_list_ziswaf.map(data =>  (
