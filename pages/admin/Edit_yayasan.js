...
class Edit_yayasan extends Component{
  ...
  componentDidMount(){
    ...
    if (localStorage.getItem('session_login')) {
      this.fetchData(this.props.query.id);
      this.getSession();
    } else {
  ...
  fetchData=(id)=>{
    ...
    axios({
      method: 'get',
      url: URL+'/admin_sosial/getYayasan/'+id,
      data: '',
      responseType: 'stream'
    }).then(
      (result) => {
        ...
        let file_name = result.data.yayasan.foto_profile.split("/");
        this.setState({
          id : result.data.yayasan.id,
          nama_yayasan:result.data.yayasan.nama,
          alamat:result.data.yayasan.alamat,
          deskripsi:result.data.yayasan.deskripsi,
          email:result.data.yayasan.email,
          telepon:result.data.yayasan.telepon,
          password:result.data.yayasan.password,
          confirm_password:result.data.yayasan.password,
          url_youtube:result.data.yayasan.url_youtube,
          url_linkedin:result.data.yayasan.url_linkedin,
          url_website:result.data.yayasan.url_website,
          id_twitter:result.data.yayasan.id_twitter,
          id_instagram:result.data.yayasan.id_instagram,
          id_facebook:result.data.yayasan.id_facebook,
  ...
  saveData=()=>{
    ...
    if(this.state.file == ''){
      ...
      formData.append('id_m_yayasan',this.state.id);
      axios(
        {
          method: 'post',
          ...
          data : formData,
            ...
            Swal.fire("Gagal", "Simpan Data Gagal, Coba beberapa saat lagi","error")
            this.setState({ error });
          }
      )
    }
  ...
  postData=(data)=>{
    axios({
      method: 'post',
      url: URL+'/admin_sosial/EditYayasan/',
      data: data,
      responseType: 'stream'
    }).then(
      (result) => {
  ...
  render(){
    return(
        <LayoutAdmin title='Edit Yayasan' username={this.state.session_username}>
          ...
          <div className="row">
            <div id="col" className="col-12 col-md-12 mt-30">
              <span className="mb-10 pb-10 ">
                <h1 className="no-paddingTop font-w400" style={{float: 'left', marginBlockEnd: '0em', color: '#31394D'}}>Edit User Yayasan</h1>
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-md-8">
                                            ...
                                            <label htmlFor="wizard-progress2-ktp">Nama Yayasan</label>
                                                <input className="form-control" type="text" value={this.state.nama_yayasan} onChange= { (input)=>  this.setState({nama_yayasan:input.target.value}) } placeholder="Masukkan Nama Yayasan..." />  
                                            </div>
                                        </div>
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="block-content block-content-full ">
                                            <Editor
                                                // da
                                                apiKey={API_KEY_TINY}
                                                initialValue={this.state.alamat}
                                                init={{
                                                height: 200,
                                                menubar: false,
                                                plugins: [
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <input className="form-control" type="text" value={this.state.email} onChange= { (input)=>  this.setState({email:input.target.value}) } placeholder="Masukkan Alamat Email..." />  
                                            </div>
                                        </div>
                                        <div className="col-md-4">
                                            <div className="form-group row ml-4">
                                            <label htmlFor="wizard-progress2-tempatlahir">Nomor Telepon</label>
                                            <input className="form-control" type="text" value={this.state.telepon} onChange= { (input)=>{this.setState({telepon:input.target.value}); this.onChangedPhoneNumber(input.target.value); } } value={this.state.telepon} placeholder="Masukkan Nomor Telepon..." />  
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="form-group row ml-4">
                                            <label htmlFor="wizard-progress2-tempatlahir">Buat Kata Sandi</label>
                                            <input className="form-control" type="password" value={this.state.password} onChange= { (input)=>  this.setState({password:input.target.value}) } placeholder="Masukkan Kata Sandi..." />  
                                            </div>
                                        </div>
                                        <div className="col-md-4">
                                            <div className="form-group row ml-4">
                                            <label htmlFor="wizard-progress2-tempatlahir">Ulangi Kata Sandi</label>
                                            <input className="form-control" type="password" value={this.state.confirm_password} onChange= { (input)=>this.setState({confirm_password:input.target.value}) } placeholder="Masukkan Ulangi Kata Sandi..." />  
                                            </div>
                                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <input className="form-control" type="text" value={this.state.url_youtube} onChange= { (input)=>  this.setState({url_youtube:input.target.value}) } placeholder="Masukkan Url..." />  
                                            </div>
                                        </div>
                                        <div className="col-md-4">
                                            <div className="form-group row ml-4">
                                            <label htmlFor="wizard-progress2-tempatlahir">ID Instagram</label>
                                            <input className="form-control" type="text" value={this.state.id_instagram} onChange= { (input)=>this.setState({id_instagram:input.target.value}) } placeholder="Masukkan username..." />  
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="form-group row ml-4">
                                            <label htmlFor="wizard-progress2-tempatlahir">ID Twitter</label>
                                            <input className="form-control" type="text" value={this.state.id_twitter} onChange= { (input)=>  this.setState({id_twitter:input.target.value}) } placeholder="Masukkan username..." />  
                                            </div>
                                        </div>
                                        <div className="col-md-4">
                                            <div className="form-group row ml-4">
                                            <label htmlFor="wizard-progress2-tempatlahir">ID Facebook</label>
                                            <input className="form-control" type="text" value={this.state.id_facebook} onChange= { (input)=>this.setState({id_facebook:input.target.value}) } placeholder="Masukkan username..." />  
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="form-group row ml-4">
                                            <label htmlFor="wizard-progress2-tempatlahir">Url LinkedIn</label>
                                            <input className="form-control" type="text" value={this.state.url_linkedin} onChange= { (input)=>  this.setState({url_linkedin:input.target.value}) } placeholder="Masukkan user..." />  
                                            </div>
                                        </div>
                                        <div className="col-md-4">
                                            <div className="form-group row ml-4">
                                            <label htmlFor="wizard-progress2-tempatlahir">Url Website</label>
                                            <input className="form-control" type="text" value={this.state.url_website} onChange= { (input)=>this.setState({url_website:input.target.value}) } placeholder="http://websiteanda.com" />  
                                            </div>
                                        </div>
